...
(function ($) {
    ...
    function Dropdown(elem, options) { // 构造函数 在大家都还执行的地方传参$elems
        ...
        // this.$elem.hover(this.show, this.hide); // 鼠标移入执行show 鼠标移出执行 hide
        ...
        // };
        // this.hide = function() { // 每次都会在堆内存中开辟一份空间 来存放 浪费性能 可以改进
    ...
    // var dropdown = new Dropdown(); // 构造函数 通过new 实例化 生成一个对象 用dropdown 保存
