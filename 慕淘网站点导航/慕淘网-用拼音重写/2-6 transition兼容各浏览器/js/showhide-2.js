// 使用 window.mt_duixiang 调用 获得 transitionEnd_bianliang、isSupport_bianliang 上的值
// console.log(window.mt_duixiang.transition_shuxing_duixiang.end_shuxing);
// console.log(window.mt_duixiang.transition_shuxing_duixiang.isSupport_shuxing);
var transition_bianliang = window.mt_duixiang.transition_shuxing_duixiang;
// console.log(transition_bianliang);
    ...
    fade_fangfa: { // 淡入淡出
        ...
        xianshi_hanshu: function ($canshu) {
            ...
            xianshi_gonggong_hanshu($canshu, function () {
                ...
                // 这是本次修改的 修改后不会发送 shown ？？？ 原因是将transition_bianliang.end_shuxing 放到'' 里了 变量放到 '' 里变成普通字符串 
