...
var js_duixiang = {
    ...
    fadeslideUpDown_fangfa: { // 淡入淡出上下滚动  多一个opacity 实现淡入淡出
        init: function ($elem) { //  获取元素的 height padding-top padding-bottom 
            ...
            // style_baocun_duixiang['opacity'] = $elem.css('opacity');
            // style_baocun_duixiang['height'] = $elem.css('height'); //  保存元素 height
            // style_baocun_duixiang['padding-top'] = $elem.css('padding-top'); 
            // style_baocun_duixiang['padding-bottom'] = $elem.css('padding-bottom');
            // $elem.data('style_data', style_baocun_duixiang); // 保存数据到data上
        ...
        xianshi_hanshu: function ($canshu) {
            ...
            //         'height': style_data['height'], // 改变宽度 
            //         'padding-top': style_data['padding-top'],
            //         'padding-bottom': style_data['padding-bottom']
            //     }, function () { // 在animate 的回调函数里 发送shown
            //         $canshu.data('status', 'shown').trigger('shown');
            //     });
            // });
...
js_duixiang._init_neibu_animate = function ($elem, animate_duixiang) { // 用animate_duixiang参数接收
    ...
    // 使用变量赋值方法 将元素的css样式 取出来 放到一个新对象里 
